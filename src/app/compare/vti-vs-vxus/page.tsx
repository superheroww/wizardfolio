          ...
          <table className="min-w-full text-left text-sm">
            <thead>
              <tr>
                ...
                <th className="border-b px-2 pb-2 text-xs font-semibold text-zinc-900">VXUS</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-zinc-500">Index / region</td>
              ...
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-zinc-500">Holdings coverage</td>
              ...
              <tr>
                <td className="py-2 pr-4 text-xs text-zinc-500">Portfolio pairing</td>
