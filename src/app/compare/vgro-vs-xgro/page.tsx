          ...
          <table className="min-w-full text-left text-sm">
            <thead>
              <tr>
                ...
                <th className="border-b px-2 pb-2 text-xs font-semibold text-zinc-900">VGRO</th>
                <th className="border-b px-2 pb-2 text-xs font-semibold text-zinc-900">XGRO</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-zinc-500">Underlying building blocks</td>
