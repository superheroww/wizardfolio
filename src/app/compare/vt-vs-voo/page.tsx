  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-8 px-4 py-10">
          ...
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-neutral-500">Index scope</td>
                <td className="py-2 pr-4 text-sm">FTSE Global All Cap / worldwide.</td>
                <td className="py-2 pr-4 text-sm">S&P 500 (U.S. large-cap). </td>
              </tr>
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-neutral-500">Region diversification</td>
              ...
              <tr>
                <td className="py-2 pr-4 text-xs text-neutral-500">Pairing</td>
      ...
      <section className="rounded-2xl border border-neutral-200 bg-white/80 p-4 text-sm text-neutral-700">
        <p className="mb-2 text-base font-semibold text-neutral-900">Mix VT and VOO and see your true exposure</p>
