  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-8 px-4 py-10">
          ...
          <table className="min-w-full text-left text-sm">
            <thead>
              <tr>
                ...
                <th className="border-b px-2 pb-2 text-xs font-semibold text-neutral-500">VBAL</th>
                <th className="border-b px-2 pb-2 text-xs font-semibold text-neutral-500">XBAL</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="border-b">
                <td className="py-2 pr-4 text-xs text-neutral-500">Building blocks</td>
      ...
      <section className="grid gap-4 rounded-2xl border border-neutral-200 bg-white/80 p-4 text-sm text-neutral-700 md:grid-cols-2">
        <div>
          <p className="text-base font-semibold text-neutral-900">How investors often use VBAL</p>
          <p className="text-sm text-neutral-700">
        ...
        <div>
          <p className="text-base font-semibold text-neutral-900">How investors often use XBAL</p>
          <p className="text-sm text-neutral-700">
      ...
      <section className="rounded-2xl border border-neutral-200 bg-white/80 p-4 text-sm text-neutral-700">
        <p className="mb-2 text-base font-semibold text-neutral-900">Mix VBAL and XBAL and see your true exposure</p>
