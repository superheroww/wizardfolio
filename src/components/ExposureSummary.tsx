    ...
    <div className="flex w-full flex-col items-center gap-6 md:flex-row md:items-center md:justify-between md:gap-10">
      ...
      <div className="relative h-56 w-56 md:h-60 md:w-60">
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
          <p className="mt-0.5 text-sm font-medium tracking-tight text-[--color-foreground] md:text-[15px]">
            {classification}
          </p>
          <p className="mt-0.5 text-[11px] text-[--color-text-muted] tabular-nums">
